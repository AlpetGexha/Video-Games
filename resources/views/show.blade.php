    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            <div class="flex-none">
                <img src="{{ Str::replaceFirst('thumb', 'cover_big', $game['cover']['url'] ?? '') }}"
                    alt="{{ $game['name'] }}" class="hover:opacity-75 transition ease-in-out duration-150 rounded-lg">
            </div>
            <div class="lg:ml-12 xl:mr-64">
                ...
                <div class="flex flex-wrap items-center mt-8">
                    ...
                    <div class="flex items-center ml-12">
                        <div class="w-16 h-16 bg-gray-800 rounded-full">
                            <div id="criticRating"
                                class="font-semibold text-xs flex justify-center items-center h-full relative"></div>
                            @push('scripts')
                                @include('_rating', [
                                    'slug' => 'criticRating',
                ...
                <div class="mt-12" x-data="{
                    ...
                    <div class="flex">
                        ...
                        @if (isset($game['gameplay']))
                            <button x-on:click="isGameplay"
                                class="flex bg-blue-500 text-white font-semibold px-4 py-4 ml-5 hover:bg-blue-600 rounded transition ease-in-out duration-150">
                                <svg class="w-6 fill-current" viewBox="0 0 24 24">
                                    <path d="M0 0h24v24H0z" fill="none"></path>
                                    <path
                                        d="M10 16.5l6-4.5-6-4.5v9zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z">
                                ...
                                <span class="ml-2">{{ __('Gameplay') }}</span>
                            </button>
                        @endif
                    </div>
                                ...
                                <div class="bg-gray-900 rounded">
                                    ...
                                    <div class="modal-body px-8 py-8">
                                        <div class="responsive-container overflow-hidden relative"
                                            ...
                                            <template x-if="isTrailer">
                                                <iframe width="560" height="315"
                                                    class="responsive-iframe absolute top-0 left-0 w-full h-full"
                                                    src="https://youtube.com/embed/{{ $game['trailer'] }}"
                                            ...
                                            <template x-if="!isTrailer">
                                                <iframe width="560" height="315"
                                                    class="responsive-iframe absolute top-0 left-0 w-full h-full"
                                                    src="https://youtube.com/embed/{{ $game['gameplay'] }}"
                                                    style="border:0;" allow="autoplay; encrypted-media" allowfullscreen>
                                                </iframe>
                                            </template>
                ...
                <div style="background-color: rgba(0, 0, 0, .5);"
                    ...
                    <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                        <div class="bg-gray-900 rounded">
                            ...
                            <div class="modal-body px-8 py-8">
                                <img :src="image" alt="{{ $game['name'] }}" class="rounded"
                                    loading='lazy'>
                            </div>
                        </div>
                    </div>
        ...
        <div class="similar-games-container mt-8">
            ...
            <div class="similar-games text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-12">
                @forelse ($game['similar_games'] as $info)
                    <x-cart :$info />
                @empty
                @endforelse
                {{-- <x-cart :$info /> --}}
